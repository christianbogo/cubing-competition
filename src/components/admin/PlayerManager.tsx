  ...
  return (
    <div className="w-full flex flex-col gap-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        ...
        {/* FFA vs Teams Toggle */}
        <div className="flex items-center bg-neutral-900 border border-neutral-700 p-1 rounded-2xl shrink-0">
          <button
          ...
          <button
            ...
            className={`flex items-center gap-1.5 px-3 py-1.5 rounded-xl text-xs font-mono font-bold transition-all ${
              isTeamMode
                ? 'bg-gradient-to-r from-red-600 to-cyan-600 text-white shadow-md'
                : 'text-neutral-400 hover:text-white'
            }`}
          >
      ...
      {players.length < 10 && (
        <form
          onSubmit={handleAdd}
          className="flex flex-wrap items-center gap-2 p-3 bg-neutral-900/90 border border-neutral-800 rounded-2xl"
        >
          <input
            type="text"
            ...
            className="flex-1 min-w-[140px] px-3 py-2 bg-neutral-950 border border-neutral-700 rounded-xl text-xs font-mono text-white placeholder-neutral-500 focus:outline-none focus:border-amber-500"
          />
          ...
          <button
            type="submit"
            className="flex items-center gap-1.5 px-4 py-2 bg-amber-500 hover:bg-amber-400 text-black font-black text-xs font-mono rounded-xl transition-all shadow-md active:scale-95"
          >
            ...
            >
              ...
              <div className="flex items-center gap-3">
                <div className="flex items-center gap-1.5 font-mono text-xs">
                  ...
                  <span className="w-8 h-8 rounded-xl bg-neutral-950 border border-neutral-700 flex items-center justify-center font-black text-amber-400 shadow-inner">
                ...
                {editingId === player.id ? (
                  <div className="flex items-center gap-2">
                    <input
                      ...
                      className="px-2 py-1 bg-neutral-950 border border-amber-500 rounded-lg text-xs font-mono text-white"
                      autoFocus
                    />
                    <button
              ...
              <div className="flex items-center gap-1.5">
                ...
                <button
                  ...
                  className="p-2 rounded-xl bg-neutral-950 border border-neutral-800 hover:border-neutral-700 text-neutral-300 disabled:opacity-30 disabled:pointer-events-none transition-all active:scale-95"
                >
                ...
                {players.length > 2 && (
                  <button
                    ...
                    title="Remove player"
                    className="p-2 rounded-xl bg-neutral-950 border border-neutral-800 hover:border-red-500/50 text-neutral-500 hover:text-red-400 transition-all active:scale-95"
                  >
